...
class ThemeCustomize {
    ...
    public static function register ( $wp_customize )
    {
        ...
        */
        ...
        $wp_customize->add_setting( 'nouveau_theme_options[link_textcolor]',    //Give it a SERIALIZED name (so all theme settings can live under one db record)
    ...
    public static function live_preview()
    {
        wp_enqueue_script(
              ...
              NV_JS . '/theme-customizer.min.js',               //Define its JS file
