...
/**
 * Can be used for dynamic/programmatic generation of HTML/XML/etc.
 */
class MarkupGenerator {
	 ...
	 * @param boolean $solo_tag Optional. Whether this tag is self-contained (such as <img/> or <br/>)
	 *
	 * @return string Returns the assembled element html.
	 */
	public static function gen( $tag, $content = '', $atts = array(), $solo_tag = false ) {
