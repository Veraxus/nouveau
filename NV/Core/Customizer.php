...
/**
 * Contains methods for modifying the theme customization screen.
 *
...
class Customizer
{
    ...
    public static function register($wp_customize)
    {
        ...
        */
        ...
        $wp_customize->add_setting(
            'nouveau_theme_options[link_textcolor]',
        ...
        $wp_customize->add_control(
            new \WP_Customize_Color_Control(                                // Instantiate the color control class
                ...
                [
                    ...
                    'settings' => 'nouveau_theme_options[link_textcolor]',
    ...
    public static function live_preview()
    {
        wp_enqueue_script(
            ...
            Core::i()->urls->debug_asset('theme-customizer.min.js'), //Define its JS file
